    ...
    <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto no-scrollbar">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <a href="<?php echo e($link['route']); ?>"
               class="sidebar-link flex items-center gap-3 px-3 py-3 rounded-xl <?php echo e($isActive ? 'active' : 'text-slate-600'); ?>">
                <svg class="w-5 h-5 <?php echo e($isActive ? 'stroke-white' : 'stroke-slate-500'); ?> flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($link['icon']); ?>"/>
                </svg>
                <span class="text-sm font-bold"><?php echo e($link['label']); ?></span>
            </a>
...
<?php /**PATH C:\Users\abd-allah\Desktop\New folder (2)\resources\views/components/crm-sidebar.blade.php ENDPATH**/ ?>