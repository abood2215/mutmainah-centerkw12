<div dir="rtl" class="min-h-screen bg-[#F0F2FF] p-6 lg:p-8 animate-slide-up">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <form wire:submit.prevent="createCampaign" class="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($targetFilter != 'all'): ?>
                    ...
                    <div class="bg-indigo-50 border border-indigo-100 rounded-xl p-4 flex items-center justify-between">
                        ...
                        <div class="text-3xl font-black text-indigo-700"><?php echo e($this->audienceCount); ?><span class="text-sm font-bold"> عميل</span></div>
                    </div>
        ...
        <div class="lg:col-span-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($campaigns) == 0): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campaign): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all p-5">
                            <div class="flex items-center justify-between mb-4">
                                <span class="text-xs font-bold text-slate-500 bg-slate-100 px-3 py-1 rounded-lg uppercase"><?php echo e($campaign->type); ?></span>
                                <div class="flex items-center gap-1.5">
                                    <div class="w-2 h-2 rounded-full <?php echo e($campaign->status == 'sent' ? 'bg-emerald-500' : 'bg-amber-500'); ?> animate-pulse"></div>
                                    <span class="text-xs font-bold <?php echo e($campaign->status == 'sent' ? 'text-emerald-600' : 'text-amber-600'); ?>">
                                        <?php echo e($campaign->status == 'sent' ? 'مرسلة' : ($campaign->status == 'scheduled' ? 'مجدولة' : $campaign->status)); ?>

                                    </span>
                                </div>
                            </div>

                            <h3 class="text-base font-black text-slate-900 mb-2"><?php echo e($campaign->title); ?></h3>
                            <p class="text-xs text-slate-500 font-semibold leading-relaxed mb-4 line-clamp-2"><?php echo e($campaign->message); ?></p>

                            <div class="grid grid-cols-2 gap-3 pt-4 border-t border-slate-100">
                                <div class="bg-slate-50 rounded-xl p-3">
                                    <div class="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-1">المستلمون</div>
                                    <div class="text-2xl font-black text-slate-800"><?php echo e($campaign->recipients_count); ?></div>
                                </div>
                                <div class="bg-indigo-50 rounded-xl p-3">
                                    <div class="text-[10px] text-indigo-500 font-black uppercase tracking-widest mb-1">الردود</div>
                                    <div class="text-2xl font-black text-indigo-700"><?php echo e($campaign->replies_count); ?></div>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\Users\abd-allah\Desktop\New folder (2)\resources\views/livewire/crm/campaigns.blade.php ENDPATH**/ ?>