            ...
            <div class="p-5 space-y-3">
                ...
                <div class="bg-slate-50 rounded-xl divide-y divide-slate-100 overflow-hidden border border-slate-200">
                    <div class="flex items-center justify-between px-4 py-3">
                        ...
                        <span class="text-xs font-bold text-slate-800 font-mono" dir="ltr"><?php echo e(config('chatwoot.url') ?: '—'); ?></span>
                    </div>
                    <div class="flex items-center justify-between px-4 py-3">
                        <span class="text-xs font-black text-slate-500 uppercase tracking-widest">Account ID</span>
                        <span class="text-xs font-bold text-slate-800 font-mono"><?php echo e(config('chatwoot.account_id')); ?></span>
                    </div>
                    <div class="flex items-center justify-between px-4 py-3">
                        <span class="text-xs font-black text-slate-500 uppercase tracking-widest">Inbox ID</span>
                        <span class="text-xs font-bold text-slate-800 font-mono"><?php echo e(config('chatwoot.inbox_id')); ?></span>
                    </div>
                    <div class="flex items-center justify-between px-4 py-3">
                        ...
                        <span class="text-xs font-bold text-slate-500 font-mono">
                            <?php echo e(config('chatwoot.api_token') ? '••••••••' . substr(config('chatwoot.api_token'), -6) : '—'); ?>
                ...
                <a href="<?php echo e(config('chatwoot.url')); ?>" target="_blank"
            ...
            <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div class="p-5 space-y-4">
                    <div class="bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 flex items-center justify-between gap-3">
                        <code class="text-xs text-indigo-700 font-bold break-all flex-1" dir="ltr"><?php echo e($webhookUrl); ?></code>
                        <button onclick="navigator.clipboard.writeText('<?php echo e($webhookUrl); ?>').then(() => this.textContent = 'تم ✓').catch(() => {}); setTimeout(() => this.textContent = 'نسخ', 2000)"
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="bg-slate-50 rounded-xl p-3">
                            ...
                            <div class="text-xs font-black text-slate-700 font-mono break-all"><?php echo e(config('whatsapp.verify_token')); ?></div>
                        </div>
                        <div class="bg-slate-50 rounded-xl p-3">
                ...
                <div class="p-5">
                    <div class="bg-slate-50 rounded-xl divide-y divide-slate-100 overflow-hidden border border-slate-200">
                        <div class="flex items-center justify-between px-4 py-3">
                            ...
                            <span class="text-xs font-bold text-slate-700 font-mono" dir="ltr"><?php echo e(config('whatsapp.phone_number_id') ?: '—'); ?></span>
                        </div>
                        <div class="flex items-center justify-between px-4 py-3">
                            <span class="text-xs font-black text-slate-500">Business Account ID</span>
                            <span class="text-xs font-bold text-slate-700 font-mono" dir="ltr"><?php echo e(config('whatsapp.business_account_id') ?: '—'); ?></span>
                        </div>
                        <div class="flex items-center justify-between px-4 py-3">
                            <span class="text-xs font-black text-slate-500">Access Token</span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(config('whatsapp.token')): ?>
...
<?php /**PATH C:\Users\abd-allah\Desktop\New folder (2)\resources\views/livewire/crm/settings.blade.php ENDPATH**/ ?>