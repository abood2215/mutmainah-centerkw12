<div dir="rtl" class="min-h-screen bg-[#F0F2FF] p-6 lg:p-8 animate-slide-up">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="text-4xl font-black text-amber-600">{{ $stats['inprogress'] }}</div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div class="text-4xl font-black text-emerald-600">{{ $stats['done'] }}</div>
        </div>
        ...
        <div class="bg-gradient-to-br from-red-500 to-rose-600 rounded-2xl p-5 shadow-lg shadow-red-500/20">
            ...
            <div class="text-4xl font-black text-white">{{ $stats['overdue'] }}</div>
        </div>
    </div>
    ...
    <div class="space-y-3">
        @forelse($tasks as $task)
            ...
            @endphp
            <div class="bg-white rounded-2xl border {{ $isOverdue ? 'border-red-200 shadow-red-100' : 'border-slate-200' }} shadow-sm hover:shadow-md transition-all group">
